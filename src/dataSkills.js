const dataSkills = [
    ...
    {id: 0, skills:'Programming', tools: 'HTML, CSS, Js, React.js, Node.js, Mongo db',
    text:'First,  as a developer i need to find a problem they can solve with software. Then, I have to figure out how to solve that problem. And then, i have to find a way to effectively translate both the problem and the solution into code that a computer can use to solve the problem as well as (or better than) a person.'
    },
    {id: 1, skills:'Design', tools: 'Figma, Photoshop, After Efect, Cinema 4D',
    ...
    {id:2 ,skills: 'Teamwork skills', tools: 'jira',
